          ...
          {report.forwarding
            ? report.forwarding.state === "diteruskan"
              ...
              : report.forwarding.state === "diusulkan"
                ? ` · Diusulkan diteruskan, menunggu persetujuan Dinkes`
            ...
            : next === "terverifikasi"
              ? handlingMode === "dlh"
                ? canForward
                  ...
                  : `${id} diterima. Usulan penerusannya menunggu persetujuan Dinkes.`
                : handlingMode === "mandiri_warga"
                  ? pattern
                    ? `${pattern} laporan serupa di wilayah ini — ${id} diusulkan untuk diteruskan.`
    ...
    <div className="space-y-6">
      <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <SummaryTile
          ...
          hint={
            summary.diusulkan > 0
              ? `Disetujui Dinkes, penyampaiannya belum tercatat. ${summary.diusulkan} usulan puskesmas menunggu persetujuan.`
              : "Disetujui Dinkes dan dirutekan ke instansi lain; penyampaiannya belum tercatat."
          }
