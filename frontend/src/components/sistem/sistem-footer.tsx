      ...
      <div className="container py-14">
        <div className="grid gap-10 lg:grid-cols-12">
          ...
          <div className="lg:col-span-4">
            ...
            <dl className="mt-6 space-y-3 text-caption">
              <div className="flex gap-2.5">
                <MapPin
                  className="mt-0.5 h-3.5 w-3.5 shrink-0 text-paper-600"
                  aria-hidden
                />
                <dd className="text-paper-600">
                  Jl. Pandanaran No. 79, Mugassari, Semarang Selatan, Kota
                  Semarang 50241
                </dd>
              </div>
              <div className="flex gap-2.5">
          ...
          {COLUMNS.map((col) => (
            ...
            >
              <h2 className="font-mono text-3xs uppercase tracking-[0.08em] text-paper-600">
                {col.title}
              </h2>
              ...
              {col.note ? (
                <p className="mt-4 inline-flex items-center gap-1.5 font-mono text-3xs uppercase tracking-[0.07em] text-paper-600">
        ...
        <div className="mt-12 flex flex-col gap-4 border-t border-sand-200 pt-6 sm:flex-row sm:items-center sm:justify-between">
          ...
          <div className="flex flex-wrap items-center gap-2">
            ...
            <Link
              href="/"
              className="inline-flex items-center gap-2 self-start rounded-lg border border-sand-300 bg-white px-3 py-2 font-mono text-3xs uppercase tracking-[0.08em] text-paper-600 transition-colors duration-fast hover:border-brand-300 hover:text-brand-700"
            >
